...
```bash
curl -s http://localhost:8002/api/v1/search \
...
```bash
curl -s http://localhost:8002/api/v1/write \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -s http://localhost:8002/api/v1/read/shared/MEMORY.md
```
...
```bash
curl -s http://localhost:8002/api/v1/list/agents/alice/logs
```
...
```bash
curl -s http://localhost:8002/api/v1/edit \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -s http://localhost:8002/api/v1/status
```
